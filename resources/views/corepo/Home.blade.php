            ...
            <div class="flex one ">
                <div class="text-center ">
                    <div class="flex one two-500 ">
                        <a class="pb-0" href="https://edengoldgallery.ir/?ref=corepo" target="__blunk"><img height="" class="full border-radius-10 " src="{{ asset('/img/eden-70.jpg') }}" alt=""></a>
                        <a class="pb-0" href="https://it-times-store.com/?ref=corepo" target="__blunk"><img height="" class="full border-radius-10 " src="{{ asset('/img/it-70.jpg') }}" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="flex one">
                    ...
                    <div class="flex gap-x-3  align-items-center p-0 pt-1 ">
                        <a class="" href="{{ url($content['slug']) }}">
                            <img class="rounded" width="70" height="70" alt="{{ $content['title'] }}" src="{{ $content['images']['images']['small'] }}">
                        </a>
                        <div class="">
            ...
            <div class="shadow full-height border-radius-10 pt-0">
                ...
                <div class="flex one">
                    ...
                    <div class="flex gap-x-3 align-items-center p-0 pt-1 min-height ">
                        <a class="" href="{{ url($content['slug']) }}">
                            <img class="rounded p-0" width="70" height="70" alt="{{ $content['title'] }}" src="{{ $content['images']['images']['small'] }}">
                        </a>
                ...
                <div class="grid grid-cols-2 gap-x-3">
                    ...
                    <div class="flex  px-0 py-1  ">
                        <a class="max-md:w-full md:w-2/5" href="{{ url($content['slug']) }}">
                            <img class="max-md:w-full rounded p-0 ml-1" width="160" height="160" src="{{ $content['images']['images']['small'] }}" alt="">
                        </a>
...
<section class="bg-pink  mt-0 mb-0  ">
    <div class="flex one ">
        <div class="text-center pb-0 pt-1">
            <div class="flex one two-500 ">
                <a class="" href="https://garmgah.com/?ref=corepo" target="__blank"><img height="" class=" border-radius-10 " src="{{ asset('/img/garmgah-70.jpg') }}" alt=""></a>
                <a class="" href="#"><img height="" class=" border-radius-10 " src="{{ asset('/img/banner-70.jpg') }}" alt=""></a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="">
            <div class="shadow border-radius-10 pt-0 full-height">
                ...
                <div class="flex four-800 align-items-center px-0 py-1 @if (!$loop->last) border-bottom @endif ">
                    <img class="fourth-800 rounded p-0 pl-1" width="100" height="100" src="{{ $content['images']['images']['small'] }}" alt="">
            ...
            <a href="{{ $content->slug }}">
                <article class="shadow2 ">
                    ...
                    <figure class="image m-0">
                        <img loading="lazy" src="{{ $content->images['images']['small'] }}" alt="{{ $content->title }}" width="80" height="80">
                    </figure>
                    @endif
        ...
        <div class="flex-1">
            <a href="/بازی-و-اپلیکیشن">
                <article class="shadow2 py-3">
                    <svg height="70px" width="70px" id="Layer_1" style="enable-background:new 0 0 32 32;" version="1.1" viewBox="0 0 32 32" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
