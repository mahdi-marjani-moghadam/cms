    ...
    <div class="flex one ">
        <div class="text-center">
                    ...
                    <a href="{{ $content->slug }}">
                        <article class=" shadow2 flex flex-row justify-between">
                            ...
                            <figure class="image flex-none max-sm:w-32  max-sm:pl-4 mt-0">
                                <img loading="lazy" src="{{ $content->images['images']['medium'] }}" width="{{ env('ARTICLE_SMALL_W') }}" height="{{ env('ARTICLE_SMALL_H') }}" alt="{{ $content->title }}">
                            </figure>
                            @else
                            <figure class="image flex-none max-sm:w-32  max-sm:pl-4 mt-0">
                                <img src="{{ asset('img/placeholder-post.png') }}" width="{{ env('ARTICLE_SMALL_W') }}" height="{{ env('ARTICLE_SMALL_H') }}" alt="{{ $content->title }}">
                            </figure>
                            @endif
            ...
            <div class="grid gap-1 grid-cols-1 sm:grid-cols-2">
                <a class="block" href="https://edengoldgallery.ir/?ref=corepo" target="__blunk"><img height="" class="w-full border-radius-10 " src="{{ asset('/img/eden-70.jpg') }}" alt=""></a>
                <a class="block" href="https://it-times-store.com/?ref=corepo" target="__blunk"><img height="" class="w-full border-radius-10 " src="{{ asset('/img/it-70.jpg') }}" alt=""></a>
            </div>
            ...
            <a href="{{ $content->slug }}">
                <article class="shadow2 ">
                    ...
                    <figure class="image m-0">
                        <img loading="lazy" src="{{ image_or_placeholder($content->images['images']['small']) }}" alt="{{ $content->title }}" width="80" height="80">
                    </figure>
                    @endif
        ...
        <div class="p-1 w-full  sm:basis-1/3 md:basis-1/6">
            <a href="/برنامه-و-اپلیکیشن">
                <article class="shadow2 py-3 max-sm:flex max-sm:flex-wrap max-sm:!flex-row ">
                    <svg class="max-sm:h-5 max-sm:!mt-0 max-sm:order-2" height="70px" width="70px" id="Layer_1" style="enable-background:new 0 0 32 32;" version="1.1" viewBox="0 0 32 32" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
<section class="bg-pink  mt-0 mb-0  ">
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-1">
        ...
        <a class="block flex-1" href="https://garmgah.com/?ref=corepo" target="__blank"><img height="" class=" full border-radius-10  " src="{{ asset('/img/garmgah-70.jpg') }}" alt=""></a>
                        ...
                        <div class="flex  flex-row align-items-center px-0 py-1 border-b last:border-b-0 ">
                            <div class="flex gap-x-3 align-items-center p-0 pt-1 min-height ">
                                <a class="" href="{{ url($content['slug']) }}">
                                    ...
                                    <img class="rounded p-0" width="70" height="70" alt="{{ $content['title'] }}" src="{{ image_or_placeholder($content['images']['images']['small']) }}">
                            ...
                            <div class="flex one ">
                                ...
                                <div class="flex gap-x-3 align-items-center p-0 pt-1 min-height ">
                                    ...
                                    <div class="flex-1 pb-0 flex mb-0">
                                        <a class="full p-0 m-0 line-clamp-2" href="{{ url($content['slug']) }}">{{ $content['title'] }}</a>
                                        <div class="flex gap-x-3 justify-between font-08">
                                            @include(asset('widget.publishDate'))
                                            @include(asset('widget.rate'))
                                            @include(asset('widget.viewCount'))
                ...
                <div class="">
                    <a href="{{ $content->slug }}">
                        <article class=" shadow2 flex flex-row justify-between">
                            ...
                            <figure class="image flex-none max-sm:w-32  max-sm:pl-4 mt-0">
                                <img loading="lazy" src="{{ image_or_placeholder($content->images['images']['medium']) }}" width="{{ env('ARTICLE_SMALL_W') }}" height="{{ env('ARTICLE_SMALL_H') }}" alt="{{ $content->title }}">
                            </figure>
                            @endif
