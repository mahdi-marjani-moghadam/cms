        ...
        <div class="grid sm:grid-cols-3 md:grid-cols-5 gap-x-5">
            <div class="pb-0 max-sm:w-full">
                @if (isset($detail->images['images']['small']))
                    <figure class="image">
                        <img class="" src="{{ $detail->images['images']['small'] }}" alt="{{ $detail->title }}"
            ...
            <div class=" shadow">
                <div class="">
                    ...
                    @isset($sideCategory['data'])
                        <ul class="max-sm:grid max-sm:grid-cols-2 max-sm:gap-x-1">
                            @foreach ($sideCategory['data'] as $item)
                                <li class="border-b border-gray-300 pb-1">
                                    <a class="flex gap-x-1" href="{{ url($item->slug) }} ">
                                        <div >
                                            <img class="rounded h-auto object-contain" src="{{ $item->images['images']['small'] }}" width="35" height="35"
                                            alt="">
                                        </div>
