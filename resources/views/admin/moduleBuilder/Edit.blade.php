        ...
        <div class="panel-body full-height">
            ...
            <div class="col-md-4">
                <ul>
                    ...
                    <li><a href="{{ route('moduleBuilder.update', ['fileName' => $itemFileName]) }}">{{ $itemFileName }}</a>
                    </li>
                    @endforeach
                </ul>
            </div>
            <div class="col-md-8">
                ...
                <form method="post" action="{{ route('moduleBuilder.update', ['fileName' => $fileName]) }}" enctype="multipart/form-data">
                    @method('PATCH')
                    @csrf
                            ...
                            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                <div class="panel panel-default">
                                    <div class="panel-heading" role="tab" id="heading{{ $attr['config']['var'] }}">
                                        ...
                                        <a class="btn-block btn" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse{{ $attr['config']['var'] }}" aria-expanded="true" aria-controls="collapse{{ $attr['config']['var'] }}">
                                            {{ $attr['config']['label'] }}
                                        </a>

                                    </div>

                                    <div id="collapse{{ $attr['config']['var'] }}" class="panel-collapse collapse {{-- {{ $menu_info->module == 'category' ? 'in' : '' }} --}}" role="tabpanel" aria-labelledby="heading{{ $attr['config']['var'] }}">
                                        <div class="panel-body">

                                            @for ($i = 0; $i < $attr['config']['count']; $i++) <div class="row" style="border-bottom:1px dashed #ccc; padding-bottom:1em;">
                                                <div class="col-md-1">
                                                    <label for="parent" class="col-form-label text-md-left">
                                                        Delete</label>
                                                    <input type="checkbox" name="attr[{{ $attr['config']['var'] }}][delete][{{ $i }}]" value="1" class="form-check" id="exampleCheck1">
                                                ...
                                                <div class="col-md-3 ">
                                                    ...
                                                    <img height="80" src="{{ url($widget['images'][$i]) }}" />
                                                ...
                                                <div class="col-md-3 ">
                                                    ...
                                                    <label for="parent" class="col-form-label text-md-left">@lang('messages.image')</label>
                                                    <input type="file" class="form-control" name="attr[{{ $attr['config']['var'] }}][images][{{ $i }}]" id="images" placeholder="" value="{{ old('imageUrl') }}">

                                                </div>
                                                <div class="col-md-5">
                                                    <label for="" class="col-form-label text-md-left">
                                                        @lang('messages.name')</label>
                                                    <input type="text" class="form-control" name="attr[{{ $attr['config']['var'] }}][name][{{ $i }}]" id="" placeholder="" value="{{ $widget['name'][$i] ?? ''}}">
                                                </div>
                                                <div class="col-md-1">
                                                    <label for="attr[{{ $attr['config']['var'] }}][follow][{{ $i }}]">follow</label>
                                                    <input type="checkbox" {{ (isset($widget['follow'][$i]) && $widget['follow'][$i] == '1' ) ? 'checked' : '' }} id="attr[{{ $attr['config']['var'] }}][follow][{{ $i }}]" value="1" name="attr[{{ $attr['config']['var'] }}][follow][{{ $i }}]">

                                                </div>
                                                <div class="col-md-7">
                                                    <label for="" class="col-form-label text-md-left ">Url</label>
                                                    <input type="text" class="ltr form-control" name="attr[{{ $attr['config']['var'] }}][url][{{ $i }}]" id="" placeholder="" value="{{ $widget['url'][$i] ?? '' }}">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="collapse{{ $attr['config']['var'] }}" class="panel-collapse collapse {{-- {{ $menu_info->module == 'category' ? 'in' : '' }} --}}" role="tabpanel" aria-labelledby="heading{{ $attr['config']['var'] }}">
                                    <div class="panel-body">
                                        ...
                                        @for ($i = 0; $i < $attr['config']['count']; $i++) <div class="row">
                                            ...
                                            <div class="col-md-3 ">
                                                <label for="label" class="col-form-label text-md-left">
                                                    label </label>
                                                <input type="text" id="label" class="form-control" name="attr[{{ $attr['config']['var'] }}][data][{{ $i }}][label]" value="{{ $labelValue }}">
                                            </div>
                                            <div class="col-md-3 ">
                                                <label for="number" class="col-form-label text-md-left">
                                                    number </label>
                                                <input type="text" id="number" class="form-control" name="attr[{{ $attr['config']['var'] }}][data][{{ $i }}][number]" value="{{ $numberValue }}">
                                            </div>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 ">
                                            <div class="panel-title">
                                                ...
                                                <label for="parent" class="col-form-label text-md-left">
                                                    انتخاب دسته بندی برای متغیر{{ $attr['config']['label'] }}</label>
                                                {{-- {{ dd($attr) }} --}}
                                                <select name="attr[{{ $attr['config']['var'] }}][parent_id]" id="parent_id" class="parent_id" {{-- class="form-control" --}}>
                                                    <option value="0">show {{ $attr['type'] }} from all categories</option>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input checked id="attr[{{ $attr['config']['var'] }}][child]" value="true" type="checkbox" name="attr[{{ $attr['config']['var'] }}][child]">
                                        </div>
                                    </div>
                                    @endisset
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 ">
                                            <div class="panel-title">
                                                ...
                                                <label for="parent" class="col-form-label text-md-left">Select
                                                    Image</label>
                                                <input type="file" class="form-control" name="attr[{{ $attr['config']['var'] }}][background]" id="images" placeholder="" value="{{ old('imageUrl') }}">
                                            </div>
                                        </div>
                    ...
                    @endif
                    <input type="hidden" id="type" name="attr[{{ $attr['config']['var'] }}][type]" value="{{ $attr['type'] }}">
                    <input type="hidden" id="count" name="attr[{{ $attr['config']['var'] }}][count]" value="{{ $attr['config']['count'] ?? '1' }}">
