...
@section('ckeditor')
    ...
    <script>
        CKEDITOR.replace(document.querySelector('#brief_description'), {
            ckfinder: {
        ...
        <div class="panel panel-default mat-elevation-z pos-abs chat-panel bottom-0">
            <div class="panel-body full-height">
                ...
                @if (Request()->is('*create*'))
                    ...
                    @else
                        <form method="post" action="   {{ route('category.update', $content->id) }}"
                ...
                @csrf <div class="form-group row">
                    ...
                    <div class="col-5 col-md-5">
                        ...
                        <div class="row ltr" style="display: flex">
                            ...
                            <input type="text" class="form-control ltr" style="width: 79px; border-radius:0"
                                name="prefix" placeholder="category/" value="{{ $content->prefix ?? '' }}">
                            <input type="text" class="form-control ltr" style="border-radius:0; border-left:0;"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-6 col-md-6">
                        <label for="brand" class=" col-form-label text-md-left">نوع دسته بندی:</label>
                        <div class="">
                            <select name="attr_type" class="form-control">
                                <option {{ ($content->attr_type ?? '') == 'category' ? 'selected' : '' }} value="category" >محصول / محتوا</option>
                                <option {{ ($content->attr_type ?? '') == 'company_category' ? 'selected' : '' }} value="company_category">کمپانی</option>
                                <option {{ ($content->attr_type ?? '') == 'html' ? 'selected' : '' }} value="html">استاتیک</option>
                            </select>
