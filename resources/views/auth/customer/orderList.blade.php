...
@section('Content')
    <section class="panel">
        ...
        <div class="list">
            ...
            <div class="grid grid-cols-1 gap-1 max-w-lg m-auto md:border md:p-4">
                ...
                <a class="text-black border-b last:border-b-0" href="{{ route('customer.order.detail', $content->id) }}">
                    <div class="">
                            <div class="w-full relative ">
                                ...
                                @elseif ($content->status == 2)
                                    <div>
                                        <span class="text-blue-700">فیش آپلود شده و در حال بررسی می باشد</span>
                                    </div>
                            ...
                            @if ($content->status == 0)
                                <form method="post" action="{{ route('customer.order.destroy', $content['id']) }}">
                                    ...
                                    <button class=" text-red-600 text-xs px-0"
                                        ...
                                        <span class=""><i class="fa fa-remove"></i> حذف سفارش</span>
                                    </button>
                                </form>
                            @endif
                        </div>
                        ...
                        <div class="flex  mb-3 gap-1">
                            @foreach ($content->orderDetail as $item)
                                <img class="rounded max-h-10" src="{{ image_or_placeholder($item->attributes['image']) }}">
                            @endforeach
                        </div>
