...
<div class="w-full max-w-lg m-auto mt-10 px-3 text-sm">
    <a href="{{ route('customer.order.list') }}">
        < بازگشت به سفارشات
    </a>
</div>
<section class="panel max-w-lg mx-auto mb-10 mt-0">
    ...
    <div class="list    ">
        ...
        <div class="    ">
            ...
            <div class="item border-b py-4  relative">
                <div class=" ">
                    ...
                    {{-- <div>{{ convertGtoJ($content->created_at) }}
                </div> --}}
                <div class="pr-5">
                    <div class=" text-sm">
        ...
        <div class="align-center">
            ...
            <form method="post" id="customer-order-store" class="text-center inline-block"
                action="{{ route('customer.order.store') }}">
                @csrf
                <button class="bg-lime-700 rounded px-5 py-3 mt-5 btn-buy">تایید و تکمیل سفارش </button>
            </form>
