...
<section class="profile-show">
    <div class="flex shadow">
        ...
        <div class="sm:grid sm:grid-cols-12 sm:gap-4 ">
            <div class="flex items-center justify-center col-span-12 sm:col-span-3">
                <img class="rounded" src="{{ image_or_placeholder($company->logo['large'] ?? '', 'company') }}">
            </div>
            <div class="sm:col-span-9 [&>div]:mt-4">

                @if ($company->manager != '')
                    <div class="">
                        <span class="">@lang('messages.name'):</span>
