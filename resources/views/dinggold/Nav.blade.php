    ...
    <header class='border-b py-1 px-1 lg:px-5  bg-white font-sans  '>
        <div class='flex flex-wrap items-center lg:gap-y-2 gap-y-4 gap-x-4'>
            ...
            <div class='flex items-center mr-auto lg:order-1'>
                ...
                <a href="/search?in_stock=on"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0 0 32 32" style=" fill:#000;">
            ...
            <ul id="collapseMenu"
                ...
                @endforeach
                <li class='max-lg:border-b max-lg:py-2 md:mb-0'>
                    <a class="lg:hover:text-yellow-600 text-gray-600  block font-bold text-[15px]" href="{{ route('search').'?in_stock=on' }}">جستجوگر</a>
                </li>
