                ...
                <div>
                    ...
                    <div class="flex  ">
                        ...
                        <div id="product-image" class=" w-full sm:w-1/2 lg:w-1/3  p-5  relative">
                            ...
                            <div class="">
                                <figure class="image zoom2 rounded" id="figure-main-image" onmousemove="zoom(event)" style="background-image: url({{ $detail->images['images']['xlarge'] ?? $detail->images['images']['large'] }})">
                        ...
                        <div class="  w-full  lg:w-1/3 p-5 lg:p-10">
                            <div class="bg-gray border p-2 border-radius-5">
                                ...
                                <div class="flex one">
                                    ...
                                    <div class="flex border-t p-3 justify-between"><span class="text-slate-500 text-sm">خرج کار:</span><span class="text-left">@convertCurrency($detail->attr['additionalprice']) تومان</span></div>
